...
using Distribuidora_de_Bebidas_MRJ.RefitInternalGenerated;
...
namespace Distribuidora_de_Bebidas_MRJ.RefitInternalGenerated
{
...
namespace Distribuidora_de_Bebidas_MRJ
{
    ...
    partial class AutoGeneratedICepApiService : ICepApiService
    {
        ...
        /// <inheritdoc />
        Task<WebResponse> ICepApiService.GetAddressAsync(string cep)
        {
